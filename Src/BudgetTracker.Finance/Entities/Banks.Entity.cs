...
public class Bank : BaseEntity
{
    ...
    [MaxLength(LengthConstants.MAX_BANK_LENGTH, ErrorMessage = "Bank name exceeds character limit")]
    [MinLength(LengthConstants.MIN_BANK_LENGTH, ErrorMessage = "Minimum characters are required")]
